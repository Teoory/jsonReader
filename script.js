fetch('infos.json')
  ...
  function appendData(data) {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        const addressTextElement = document.createElement('p');
        addressTextElement.id= "info";
        addressTextElement.textContent = 'state= ' + data[i].address;
        fifth.appendChild(addressTextElement);
